...
<body>
    ...
    <div class="registerform">
        <asp:Label ID="lbl_customername" runat="server">Name: </asp:Label>
         <asp:TextBox ID="txt_customername" runat="server"></asp:TextBox>

        <asp:Label ID="lbl_customeradress" runat="server">Adress: </asp:Label>
        <asp:TextBox ID="txt_customeradress" runat="server"></asp:TextBox>

        <asp:Label ID="lbl_customerphone" runat="server">Phone: </asp:Label>
